...
import (
	...
	"github.com/vahemuradyan2744/stream/utils"
...
func RegisterUser() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Faild to check existing user"})
			return
		}
...
func LoginUser() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		token, refreshToken, err := utils.GenerateAllTokens(foundUser.Email, foundUser.FirstName,
			foundUser.LastName, foundUser.Role, foundUser.UserID)
